...
## Incident reports
 In Figure \@ref(fig:Victim-distribution), there is a huge difference  the race of the victim. But we notice that the victim are either male either female.As a first step we can conclude that the gender isn't a determinant factor to determine a victim, but the race seems a signifcant variable.
