...
In the table \@ref(tab:Table-Incidents-Reports), you have an overview about the variables we will use for our project.
...
Observations: 8 
Variables: 14
In the table \@ref(tab:Table-Traffic-Stop), you have an overview about the variables we will use for our project.
...
Observations: 46
Variables:12
In the table \@ref(tab:Table-Traffic-Stop-2),
...
In the table \@ref(tab:Table-Police-Arrest-Made),

```{r Table-Police-Arrest-Made, warning=FALSE, message=FALSE, echo = FALSE}
Police_arrest_made %>%
  select(-`Incident Id`,-`Time of Arrest`,-Address) %>%
  na.omit(Incident_reports) %>%
  head(5) %>%
...
In the table \@ref(tab:Table-Job-Description),

```{r Table-Job-Description,warning=FALSE, message=FALSE, echo = FALSE}
